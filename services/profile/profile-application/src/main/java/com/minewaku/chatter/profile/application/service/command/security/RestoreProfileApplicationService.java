...
import com.minewaku.chatter.profile.application.port.inbound.command.security.usecase.RestoreProfileUseCase;
...
public class RestoreProfileApplicationService implements RestoreProfileUseCase {
	
	private final ProfileRepository profileRepository;
	

	public RestoreProfileApplicationService(
