...
import com.minewaku.chatter.profile.application.port.inbound.command.security.usecase.LockProfileUseCase;
...
public class LockProfileApplicationService implements LockProfileUseCase {

	private final ProfileRepository profileRepository;

	
	public LockProfileApplicationService(
