package com.minewaku.chatter.identityaccess.infrastructure.cache.config;
...
public class RedisConfig {
    ...
    @Bean
    RedisTemplate<String, SessionCacheDto> redisTemplateSessionDto(
            RedisConnectionFactory connectionFactory) {
        RedisTemplate<String, SessionCacheDto> template = new RedisTemplate<>();
        ...
        Jackson2JsonRedisSerializer<SessionCacheDto> serializer = new Jackson2JsonRedisSerializer<>(objectMapper,
                SessionCacheDto.class);
    ...
    @Bean
    RedisTemplate<String, ConfirmationTokenCacheDto> redisTemplateConfirmationTokenDto(
            RedisConnectionFactory connectionFactory) {
        RedisTemplate<String, ConfirmationTokenCacheDto> template = new RedisTemplate<>();
        template.setConnectionFactory(connectionFactory);
        ...
        Jackson2JsonRedisSerializer<ConfirmationTokenCacheDto> serializer = new Jackson2JsonRedisSerializer<>(objectMapper,
                ConfirmationTokenCacheDto.class);
