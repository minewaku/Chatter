package com.minewaku.chatter.identityaccess.infrastructure.integration.property;
...
public class DebeziumProperties {
    ...
    public DebeziumProperties(
		...
		props.setProperty("offset.storage.group.id", "debezium-offset-reader-group.authentication");
        ...
        props.setProperty("offset.storage.topic", "debezium-offsets.authentication");
        ...
        props.setProperty("schema.history.internal.kafka.topic", "debezium-schema-history.authentication");
