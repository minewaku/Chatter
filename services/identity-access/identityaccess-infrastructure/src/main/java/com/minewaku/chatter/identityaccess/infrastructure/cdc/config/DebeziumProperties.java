package com.minewaku.chatter.identityaccess.infrastructure.cdc.config;
...
public class DebeziumProperties {
    ...
    public DebeziumProperties(
		...
		props.setProperty("offset.storage.group.id", "debezium-offset-reader-group.identityaccess");
        ...
        props.setProperty("offset.storage.topic", "debezium-offsets.identityaccess");
